package com.sda.anca.webshop.thcontroller;
...
public class UserRegistrationController {
    ...
    @PostMapping
    public String registerAccount(@ModelAttribute("user") @Valid UserRegistrationDTO userDTO, BindingResult bindingResult){
