...
import com.sda.anca.webshop.model.*;
import com.sda.anca.webshop.repository.BillRepository;
import com.sda.anca.webshop.repository.CustomerRepository;
import com.sda.anca.webshop.repository.OrderRepository;
import com.sda.anca.webshop.repository.ProductRepository;
    ...
    if( customer.isPresent()){
        ...
        for (Long productId : orderDTO.getProductIds()){
            ...
            if (product.isPresent()){
                ...
                throw new IllegalArgumentException("no product was found in database for id: "+ productId);
            }
        }
